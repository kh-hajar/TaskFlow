...
const ScrumMasterBlueprintWizard = ({ initialData, projectId }) => {
    ...
    const validateCurrentStep = () => {
        if (currentStep === 3) {
            if (!selectedFile && !staffingData && !isAnalyzing) {
    ...
    const renderStep1 = () => (
        ...
        >
            <motion.div variants={cascadeItem} className="space-y-3 text-center">
                ...
                <h3 className="text-2xl font-black text-neutral-900 tracking-tight">Scrum Master Analysis Initialization</h3>

                <p className="text-sm text-neutral-500 font-medium leading-relaxed max-w-xl mx-auto">
                    The following key parameters are derived from the <span className="text-neutral-900 font-bold">Financial Analysis</span> you previously completed.
                </p>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <div className="pt-1">
                                ...
                                <span className="text-[11px] text-neutral-500 font-medium leading-tight block mt-0.5">{employeePool.length} Engineers assigned from financial planning.</span>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div className="w-full h-full max-w-7xl mx-auto">
            ...
            {showSteppers && (
                <div className="flex flex-col items-center justify-center space-y-3 pb-8 border-b border-neutral-100 text-center mb-8">
                    ...
                    >
                        Scrum Master <span className="text-brand-primary-500 italic">Analysis</span>
                    </motion.h1>
                                                    ...
                                                    {staffingData?.backlog ? (
                                                        <div className="bg-white/50 p-6 rounded-3xl">
                                                            <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                                                                <div>
                                                                    <h3 className="text-2xl font-black text-neutral-900 tracking-tight">Scrum Master Analysis Generated</h3>
...
export default ScrumMasterBlueprintWizard;
