...
import { login as apiLogin, refreshToken as apiRefresh, getMe, logout as apiLogout, register as apiRegister, googleLogin as apiGoogleLogin, googleRegister as apiGoogleRegister } from '@/features/auth/api/auth';
...
export const AuthProvider = ({ children }) => {
    ...
    const signupWithGoogle = async (googleData) => {
        try {
            console.log('[Auth] Google signup called with:', googleData.email);
            const response = await apiGoogleRegister(googleData);
            console.log('[Auth] Google signup response received:', {
                hasAccessToken: !!response.access_token,
                hasUser: !!response.user,
                role: response.role
            });
