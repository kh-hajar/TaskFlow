...
describe('Integration Test: Strategic Blueprint Page', () => {
    ...
    const renderWithProviders = (id = '789') => {
        return render(
            <MemoryRouter initialEntries={[`/project/${id}/blueprint`]}>
                <Routes>
                    <Route path="/project/:id/blueprint" element={<StrategicBlueprint />} />
                </Routes>
            </MemoryRouter>
        );
    };
