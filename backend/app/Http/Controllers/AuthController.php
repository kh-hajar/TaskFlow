...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        // Auto-seed a demo project and employees for the new user
        ProjectSeederService::seedForUser($user);
        EmployeeSeederService::seedForUser($user);
     ...
     * Finds existing user by google_id or email. User must sign up first.
     */
    public function googleLogin(Request $request)
    {
        ...
        if (!$user) {
            ...
            if ($user) {
                ...
                // User not found — must sign up first
                return response()->json([
                    'message' => 'Utilisateur introuvable. Veuillez vous inscrire d\'abord.',
                ], 404);
            }
        }
    ...
    /**
     * Handle Google OAuth registration via Firebase.
     * Creates a new user from Google credentials. Rejects if user already exists.
     */
    public function googleRegister(Request $request)
    {
        ...
        $existingUser = User::where('google_id', $request->google_id)
